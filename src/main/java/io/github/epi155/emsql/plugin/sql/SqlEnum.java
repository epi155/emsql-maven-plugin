...
public enum SqlEnum implements SqlKind {
    ...
    LocalDateStd("Date", "DATE", "LocalDate") {
        ...
        @Override
        public void rsGet(IndentPrintWriter ipw, int k, String target) {
            ipw.printf("%s(rs.getDate(%d).toLocalDate());%n", target, k);
        }
        @Override
        public void rsGetValue(IndentPrintWriter ipw, int k) {
        ...
        @Override
        public void csGetValue(IndentPrintWriter ipw, int k) {
            ipw.printf("return ps.getDate(%d).toLocalDate();%n", k);
        }
        @Override
        public void csGet(IndentPrintWriter ipw, int k, String setter) {
    ...
    LocalDateTimeNil("Timestamp", "TIMESTAMP", "LocalDateTime") {
        @Override
        public void psSet(IndentPrintWriter ipw, String so) {
            cc.add(ClassContext.RUNTIME_J8TIME);
