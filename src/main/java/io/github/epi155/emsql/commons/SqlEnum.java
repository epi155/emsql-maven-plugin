...
public enum SqlEnum implements SqlDataType {
    ...
    BinaryNil("Bytes", "BINARY", "byte[]") {
        @Override
        public void rsGetValue(PrintModel ipw, int k) {
            BinaryStd.rsGetValue(ipw, k);
        }

        @Override
        public void csGetValue(PrintModel ipw, int k) {
            BinaryStd.csGetValue(ipw, k);
        }
    },
    ...
    VarBinaryNil("Bytes", "VARBINARY", "byte[]") {
        @Override
        public void rsGetValue(PrintModel ipw, int k) {
            VarBinaryStd.rsGetValue(ipw, k);
        }

        @Override
        public void csGetValue(PrintModel ipw, int k) {
            VarBinaryStd.csGetValue(ipw, k);
        }
    },
    ...
    LongVarBinaryStreamNil("BinaryStream", "LONGVARBINARY", "InputStream") {
        ...
        @Override
        public void rsGetValue(PrintModel ipw, int k) {
            LongVarBinaryStreamStd.rsGetValue(ipw, k);
        }

        @Override
        public void csGetValue(PrintModel ipw, int k) {
            LongVarBinaryStreamStd.csGetValue(ipw, k);
        }
    ...
    BlobStreamNil("Blob", "BLOB", "InputStream") {
        ...
        @Override
        public void rsGetValue(PrintModel ipw, int k) {
            BlobStreamStd.rsGetValue(ipw, k);
        }

        @Override
        public void csGetValue(PrintModel ipw, int k) {
            BlobStreamStd.csGetValue(ipw, k);
        }
