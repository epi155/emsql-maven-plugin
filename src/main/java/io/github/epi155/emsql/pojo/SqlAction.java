...
import static io.github.epi155.emsql.pojo.Tools.*;
...
public abstract class SqlAction {
    ...
    public abstract JdbcStatement sql(Map<String, SqlDataType> fields) throws MojoExecutionException;

    public abstract void writeMethod(PrintModel pw, String methodName, JdbcStatement jdbc, String kPrg);


    public void writeCode(PrintModel ipw, Map<String, SqlDataType> fields, String kPrg) throws MojoExecutionException {
...
//            }
    ...
    public void writeRequest(PrintModel ipw, String cMethodName, @NotNull Map<String, SqlDataType> sp) throws MojoExecutionException {
    ...
    public void writeResponse(PrintModel ipw, String cMethodName, @NotNull Collection<SqlParam> sp) throws MojoExecutionException {
        if (sp.size()<=1) return;
