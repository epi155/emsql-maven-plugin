...
import static io.github.epi155.emsql.pojo.SqlAction.*;
import static io.github.epi155.emsql.pojo.Tools.capitalize;
...
public class ClassContext {
    ...
    public ClassContext(PluginContext pc, Map<String, TypeModel> declare) {
        this.pc = pc;
    ...
    public void writeImport(PrintModel pw) {
