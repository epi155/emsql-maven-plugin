...
public final class LongNVarCharStreamNilType implements SqlScalarType, SqlNullType {
    public static final LongNVarCharStreamNilType INSTANCE = new LongNVarCharStreamNilType();
    ...
    private LongNVarCharStreamNilType() {
    }
