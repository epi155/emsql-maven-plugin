...
public final class DateNilType implements SqlDataType {
    ...
    public void xPsPush(PrintModel ipw, String orig, String name) {
        ipw.printf("EmSQL.setDate(ps, ++ki, EmSQL.get(%s, \"%s\", Date.class));%n", orig, name);
    }

    @Override
    public void xPsPush(PrintModel ipw, String orig, String name, int k) {
        ipw.printf("EmSQL.setDate(ps, %d, EmSQL.get(%s, \"%s\", Date.class));%n", k, orig, name);
    }
