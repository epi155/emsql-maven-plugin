...
public final class LongVarCharStreamNilType implements SqlScalarType, SqlNullType {
    public static final LongVarCharStreamNilType INSTANCE = new LongVarCharStreamNilType();
    ...
    private LongVarCharStreamNilType() {
    }
