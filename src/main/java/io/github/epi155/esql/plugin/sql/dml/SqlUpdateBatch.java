...
public class SqlUpdateBatch extends SqlAction {
    ...
    public void writeMethod(IndentPrintWriter ipw, String name, JdbcStatement jdbc, String kPrg, Set<String> set) {
        ...
        if (1<iSize && iSize<=IMAX) {
            set.add("io.github.epi155.esql.runtime.ESqlUpdateBatch"+iSize);
        } else {
            set.add("io.github.epi155.esql.runtime.ESqlUpdateBatch");
        }
        ...
        ipw.more();
        declareReturnNew(ipw, "ESqlUpdateBatch", iMap, cName);
        ipw.more();
